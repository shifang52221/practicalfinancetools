# DTI Escrow Trust Batch Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Upgrade three DTI and escrow support guides to the stronger trust model while preserving route behavior, `noindex` posture, and existing article structure.

**Architecture:** Extend `tests/seo.test.ts` with one focused regression block for the selected housing-payment cluster, then make the smallest Astro edits needed to normalize trust metadata, review coverage, and date alignment. Keep references, links, body structure, and page routing intact.

**Tech Stack:** Astro, TypeScript, Node.js built-in test runner

---

### Task 1: Add failing regression coverage for the DTI escrow trust batch
...
### Task 2: Upgrade `mortgage-payment-dti-housing-payment`
...
### Task 3: Upgrade `mortgage-payment-escrow-account`
...
### Task 4: Upgrade `mortgage-payment-escrow-shortage`
...
- Modify: `tests/seo.test.ts`
- Modify: the three guide pages above
- Add: `docs/plans/2026-04-05-dti-escrow-trust-batch-design.md`
- Add: `docs/plans/2026-04-05-dti-escrow-trust-batch.md`
